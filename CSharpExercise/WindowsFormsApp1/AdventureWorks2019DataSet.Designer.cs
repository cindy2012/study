            ...
            public string OrganizationNode {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("表“Employee”中列“OrganizationNode”的值为 DBNull。", e);
                    }
                }
                set {
            ...
            public short OrganizationLevel {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("表“Employee”中列“OrganizationLevel”的值为 DBNull。", e);
                    }
                }
                set {
...
namespace WindowsFormsApp1.AdventureWorks2019DataSetTableAdapters {
...
SELECT BusinessEntityID, NationalIDNumber, LoginID, OrganizationNode, OrganizationLevel, JobTitle, BirthDate, MaritalStatus, Gender, HireDate, SalariedFlag, VacationHours, SickLeaveHours, CurrentFlag, rowguid, ModifiedDate FROM HumanResources.Employee WHERE (BusinessEntityID = @BusinessEntityID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"SELECT  BusinessEntityID, NationalIDNumber, LoginID, OrganizationNode, OrganizationLevel, JobTitle, BirthDate, MaritalStatus, 
                   Gender, HireDate, SalariedFlag, VacationHours, SickLeaveHours, CurrentFlag, rowguid, ModifiedDate
FROM      HumanResources.Employee
WHERE   (BusinessEntityID > 50 AND BusinessEntityID < 60)";
        ...
        public virtual int FillBy(AdventureWorks2019DataSet.EmployeeDataTable dataTable) {
